...
public class WordCountMain {
	public static void main(String[] args) throws Exception {
		...
		conf.set("mapred.jar", "D:/a/mapred.jar");
		...
		FileInputFormat.setInputPaths(job, "hdfs://hadoop201:8020/wang/a.txt");// 只能使用FileInputFormat设置读取目录
		FileOutputFormat.setOutputPath(job, new Path("hdfs://hadoop201:8020/out001"));// 设置输出目录
