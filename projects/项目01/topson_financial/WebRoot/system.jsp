...
<script> 
	function   keyEnter(){         
		if   (event.keyCode   ==   13)   {                
			window.location.href=document.getElementById("system").value;    
		}   
	} 
    ...
    <td width="296"><table width="296" border="0" cellpadding="0" cellspacing="0" >
      ...
      <tr>
        <td valign="top" class="back_login02">
           <form action="power!queryEmpPowerByRoleId.action" method="post" id="form1">
                      ...
                      <tr>
                        <td>
                              ...
                              请选择要进入的系统:<br/><br/>
						  	  系统选择:
						  	  <select id="system">
						  	      <option value="http://dm.hljtx.com">资源平台</option>
						  	      <option value="http://dm.hljtx.com/topson_financial">个人报账</option>
						  	  </select>
						  <br/>
						  <br/>
                        </td>
