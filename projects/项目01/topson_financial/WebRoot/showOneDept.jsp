...
<body>
<form name="dept_form" runat="server" method="post" action="dept!updateDept.action" onsubmit="return confirm('确定提交吗?');">
<input type="hidden" name="deptno" value="${deptment.deptno }">
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" id="main_table03">
  <tr>
    <td width="570" align="left"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="50%"><table width="167" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td align="left" class="back_main04"><span class="font_bold">部门管理编辑窗口</span></td>
          </tr>
        </table></td>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="10" bgcolor="#FFFFFF" class="border03">
          <tr>
            <td align="left">部门编号：       
            <input type="text" name="dnumber"  id="textfield" class="input" value="${deptment.dnumber }"/></td>
          </tr>
          <tr>
            <td align="left">部门名称：            
            <input type="text" name="dname"  id="textfield2" class="input" value="${deptment.dname }"/></td>
          </tr>
          <tr>
            <td align="left" >部门描述：            
            <textarea name="description" id="textarea" cols="48" rows="5" class="input">${deptment.description }</textarea>
            </td>
          </tr>
        </table>
    </td>
