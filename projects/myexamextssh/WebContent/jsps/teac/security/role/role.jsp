...
<html>
  <head>
	...
	<script type="text/javascript" src="<c:url value='/jsps/teac/security/role/func.js'/>"></script>
	<script type="text/javascript" src="<c:url value='/jsps/teac/security/role/role.js'/>"></script>
  </head>
  <body>
  </body>
</html>