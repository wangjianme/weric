...
<html>
  <head>
	...
	<script type="text/javascript" src="<c:url value='/jsps/teac/exam/ques/quesQueryForm.js'/>"></script>
	<script type="text/javascript" src="<c:url value='/jsps/teac/exam/ques/ques.js'/>"></script>
  </head>
  <body>
  </body>
</html>