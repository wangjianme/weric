...
<html>
  <head>
	...
	<script type="text/javascript" src="<c:url value='/jsps/teac/exam/exam/exam.js'/>"></script>
  </head>
  <body>
  	<form style="display:none;" id="viewForm" target="_blank" method="post" action="<c:url value='/examview.action'/>">
  		<input type="text" id="_examId" name="examId" value="dd"/>
  	</form>
  </body>
</html>