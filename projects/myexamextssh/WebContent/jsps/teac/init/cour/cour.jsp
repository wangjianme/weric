...
<html>
  <head>
	...
	<script type="text/javascript" src="<c:url value='/jsps/teac/init/cour/queryCourForm.js'/>"></script>
	<script type="text/javascript" src="<c:url value='/jsps/teac/init/cour/courSaveOrUpdate.js'/>"></script>
	<script type="text/javascript" src="<c:url value='/jsps/teac/init/cour/majorHelp.js'/>"></script>
	<script type="text/javascript" src="<c:url value='/jsps/teac/init/cour/cour.js'/>"></script>
  </head>
  <body>
  </body>
</html>