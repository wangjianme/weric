...
<html>
  <head>
	...
	<script type="text/javascript" src="<c:url value='/jsps/teac/init/major/deptHelp.js'/>"></script>
	<script type="text/javascript" src="<c:url value='/jsps/teac/init/major/major.js'/>"></script>
  </head>
  <body>
  </body>
</html>